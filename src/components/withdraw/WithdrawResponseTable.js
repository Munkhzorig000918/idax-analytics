...
export default function WithdrawResponseTable({ title, data }) {

    let searchFields = ['id', 'outOrderId', 'sign', 'orderNum', 'orderStatus', 'appKey', 'amount', 'createdDate']
            ...
            <div className="bg-white mt-9 rounded shadow p-4 space-y-8">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center justify-end space-x-4">
                        ...
                        <div className="pl-10"> 
                            <BiExport className="hover:text-blue-500 cursor-pointer" onClick={() => downloadExcel("Withdraw-Response", sortedData)} size={25} />
                        </div>
                    </div>
                </div>
                <div>
