...
export default function SmsResponseTable({ title, data }) {

    let searchFields = ['id', 'username', 'countryCode', 'phoneNumber', 'lang', 'responseMsg', 'createdDate']
            ...
            <div className="bg-white mt-9 rounded shadow p-4 space-y-8">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center justify-end space-x-4">
                        ...
                        <div className="pl-10"> 
                            <BiExport className="hover:text-blue-500 cursor-pointer" onClick={() => downloadExcel("Sms-Response", sortedData)} size={25} />
                        </div>
                    </div>
                </div>
                <div>
